...
buildOptions = dict(packages=["wordcloud", "idna", "re", "sys", "os", "jpype", "konlpy", "matplotlib", "macholib", "numpy", "pandas", "requests", "simplejson", "urllib3", "sqlite3", "wx"],
                    ...
                    # 워드클라우드 관련 파일 추가
                    zip_includes=[(r'WordAnalysis/venv/Lib/site-packages/wordcloud/stopwords', 'wordcloud/stopwords'),
                                  (r'WordAnalysis/venv/Lib/site-packages/wordcloud/DroidSansMono.ttf', 'wordcloud/DroidSansMono.ttf')]
