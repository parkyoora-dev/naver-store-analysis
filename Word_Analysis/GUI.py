...
class MyFrame1(wx.Frame):
    def __init__(self, parent):
        ...
        self.m_staticText10 = wx.StaticText(
            self.m_panel4, wx.ID_ANY, u"URL :", wx.DefaultPosition, wx.DefaultSize, 0)
        self.m_staticText10.Wrap(-1)
        bSizer15.Add(self.m_staticText10, 0, wx.ALL, 5)

        self.txtUrl = wx.TextCtrl(
            self.m_panel4, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0)
        bSizer15.Add(self.txtUrl, 1, wx.ALL, 5)

        self.btnView = wx.Button(
            self.m_panel4, wx.ID_ANY, u"확인", wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.lstList = wx.ListCtrl(
            self.m_panel6, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.LC_REPORT | wx.VSCROLL)
